https://github.com/AthosZn/cim
https://github.com/smallFive55/im 图片
https://github.com/crossoverJie/cis

curl -X POST --header 'Content-Type: application/json' --header 'Accept: application/json' -d '{"reqNo": "1234567890","timeStamp": 0,"userName": "zhangsan"}' 'http://localhost:8083/registerAccount'

curl -X POST --header 'Content-Type: application/json' --header 'Accept: application/json' -d '{"reqNo": "1234567890","timeStamp": 0,"userName": "lisi"}' 'http://localhost:8083/registerAccount'
